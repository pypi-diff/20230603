# Comparing `tmp/loophost-1.2.7-py3-none-any.whl.zip` & `tmp/loophost-1.2.8-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,15 +1,12 @@
-Zip file size: 345289 bytes, number of entries: 36
...
--rw-r--r--  2.0 unx        0 b- defN 80-Jan-01 00:00 loophost/bins/macOS-latest-binaries/.keep
--rw-r--r--  2.0 unx        0 b- defN 80-Jan-01 00:00 loophost/bins/ubuntu-latest-binaries/.keep
--rw-r--r--  2.0 unx        0 b- defN 80-Jan-01 00:00 loophost/bins/windows-latest-binaries/.keep
 ...
 -rw-r--r--  2.0 unx      788 b- defN 80-Jan-01 00:00 loophost/plist/hub.plist.template
 -rw-r--r--  2.0 unx      771 b- defN 80-Jan-01 00:00 loophost/plist/loophost.plist.template
 -rw-r--r--  2.0 unx     1150 b- defN 80-Jan-01 00:00 loophost/plist/ssh.plist.template
 -rw-r--r--  2.0 unx      780 b- defN 80-Jan-01 00:00 loophost/plist/tunnel.plist.template
@@ -28,11 +25,11 @@
...
--rw-r--r--  2.0 unx     1163 b- defN 80-Jan-01 00:00 loophost-1.2.7.dist-info/METADATA
--rw-r--r--  2.0 unx       88 b- defN 80-Jan-01 00:00 loophost-1.2.7.dist-info/WHEEL
-?rw-r--r--  2.0 unx     2962 b- defN 16-Jan-01 00:00 loophost-1.2.7.dist-info/RECORD
-36 files, 443779 bytes uncompressed, 340551 bytes compressed:  23.3%
...
@@ -6,23 +6,14 @@
 ...
 Filename: loophost/__init__.py
 Comment: 
 
 Filename: loophost/bins/.keep
 Comment: 
 
-Filename: loophost/bins/macOS-latest-binaries/.keep
-Comment: 
-
-Filename: loophost/bins/ubuntu-latest-binaries/.keep
-Comment: 
-
-Filename: loophost/bins/windows-latest-binaries/.keep
-Comment: 
-
 Filename: loophost/flingroute.py
 Comment: 
 
 Filename: loophost/installer.py
 Comment: 
 
 Filename: loophost/keys.py
@@ -93,17 +84,17 @@
...
-Filename: loophost-1.2.7.dist-info/METADATA
+Filename: loophost-1.2.8.dist-info/METADATA
 Comment: 
 
-Filename: loophost-1.2.7.dist-info/WHEEL
+Filename: loophost-1.2.8.dist-info/WHEEL
 Comment: 
 
-Filename: loophost-1.2.7.dist-info/RECORD
...
## Comparing `loophost-1.2.7.dist-info/METADATA` & `loophost-1.2.8.dist-info/METADATA`
...
## Comparing `loophost-1.2.7.dist-info/RECORD` & `loophost-1.2.8.dist-info/RECORD`
...
-VERSION,sha256=5xFfItk8jmF4J6XXD2GJpvj_7M8dldsmM0Uqpe1aihs,5
-loophost/__init__.py,sha256=hHa8Z-W0NAPMkqlMwLRgW1A0Aby7Ene8681I9DcuZLc,2201
...
-loophost/bins/macOS-latest-binaries/.keep,sha256=47DEQpj8HBSa-_TImW-5JCeuQeRkm5NMpJWZG3hSuFU,0
-loophost/bins/ubuntu-latest-binaries/.keep,sha256=47DEQpj8HBSa-_TImW-5JCeuQeRkm5NMpJWZG3hSuFU,0
-loophost/bins/windows-latest-binaries/.keep,sha256=47DEQpj8HBSa-_TImW-5JCeuQeRkm5NMpJWZG3hSuFU,0
 ...
 loophost/plist/tunnel.plist.template,sha256=AeGI8A4s4jM9z9FGgByDClyO5jvlgQswGT6M6pm56Ig,780
@@ -27,10 +24,10 @@
...
-loophost-1.2.7.dist-info/METADATA,sha256=dts1PeTgYLieIXGnoHQYalENNzIeefr7gjdyzFFAbes,1163
-loophost-1.2.7.dist-info/WHEEL,sha256=Zb28QaM1gQi8f4VCBhsUklF61CTlNYfs9YAZn-TOGFk,88
-loophost-1.2.7.dist-info/RECORD,,
