# Comparing `tmp/msticpy-2.5.0.tar.gz` & `tmp/msticpy-2.5.1.tar.gz`
...
### Comparing `msticpy-2.5.0/LICENSE` & `msticpy-2.5.1/LICENSE`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/NOTICE.txt` & `msticpy-2.5.1/NOTICE.txt`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/PKG-INFO` & `msticpy-2.5.1/PKG-INFO`
...
### Comparing `msticpy-2.5.0/README.md` & `msticpy-2.5.1/README.md`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/__init__.py` & `msticpy-2.5.1/msticpy/__init__.py`
...
### Comparing `msticpy-2.5.0/msticpy/analysis/__init__.py` & `msticpy-2.5.1/msticpy/analysis/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/anomalous_sequence/anomalous.py` & `msticpy-2.5.1/msticpy/analysis/anomalous_sequence/anomalous.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/anomalous_sequence/model.py` & `msticpy-2.5.1/msticpy/analysis/anomalous_sequence/model.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/anomalous_sequence/sessionize.py` & `msticpy-2.5.1/msticpy/analysis/anomalous_sequence/sessionize.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/anomalous_sequence/utils/cmds_only.py` & `msticpy-2.5.1/msticpy/analysis/anomalous_sequence/utils/cmds_only.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/anomalous_sequence/utils/cmds_params_only.py` & `msticpy-2.5.1/msticpy/analysis/anomalous_sequence/utils/cmds_params_only.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/anomalous_sequence/utils/cmds_params_values.py` & `msticpy-2.5.1/msticpy/analysis/anomalous_sequence/utils/cmds_params_values.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/anomalous_sequence/utils/data_structures.py` & `msticpy-2.5.1/msticpy/analysis/anomalous_sequence/utils/data_structures.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/anomalous_sequence/utils/laplace_smooth.py` & `msticpy-2.5.1/msticpy/analysis/anomalous_sequence/utils/laplace_smooth.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/anomalous_sequence/utils/probabilities.py` & `msticpy-2.5.1/msticpy/analysis/anomalous_sequence/utils/probabilities.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/cluster_auditd.py` & `msticpy-2.5.1/msticpy/analysis/cluster_auditd.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/code_cleanup.py` & `msticpy-2.5.1/msticpy/analysis/code_cleanup.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/eventcluster.py` & `msticpy-2.5.1/msticpy/analysis/eventcluster.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/observationlist.py` & `msticpy-2.5.1/msticpy/analysis/observationlist.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/outliers.py` & `msticpy-2.5.1/msticpy/analysis/outliers.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/polling_detection.py` & `msticpy-2.5.1/msticpy/analysis/polling_detection.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/syslog_utils.py` & `msticpy-2.5.1/msticpy/analysis/syslog_utils.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/analysis/timeseries.py` & `msticpy-2.5.1/msticpy/analysis/timeseries.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/auth/__init__.py` & `msticpy-2.5.1/msticpy/auth/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/auth/azure_auth.py` & `msticpy-2.5.1/msticpy/auth/azure_auth.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/auth/azure_auth_core.py` & `msticpy-2.5.1/msticpy/auth/azure_auth_core.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/auth/cloud_mappings.py` & `msticpy-2.5.1/msticpy/auth/cloud_mappings.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/auth/cred_wrapper.py` & `msticpy-2.5.1/msticpy/auth/cred_wrapper.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/auth/keyring_client.py` & `msticpy-2.5.1/msticpy/auth/keyring_client.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/auth/keyvault_client.py` & `msticpy-2.5.1/msticpy/auth/keyvault_client.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/auth/keyvault_settings.py` & `msticpy-2.5.1/msticpy/auth/keyvault_settings.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/auth/msal_auth.py` & `msticpy-2.5.1/msticpy/auth/msal_auth.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/auth/secret_settings.py` & `msticpy-2.5.1/msticpy/auth/secret_settings.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/__init__.py` & `msticpy-2.5.1/msticpy/common/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/azure_auth.py` & `msticpy-2.5.1/msticpy/common/azure_auth.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/check_version.py` & `msticpy-2.5.1/msticpy/common/check_version.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/data_types.py` & `msticpy-2.5.1/msticpy/common/data_types.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/data_utils.py` & `msticpy-2.5.1/msticpy/common/data_utils.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/exceptions.py` & `msticpy-2.5.1/msticpy/common/exceptions.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/pkg_config.py` & `msticpy-2.5.1/msticpy/common/pkg_config.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/provider_settings.py` & `msticpy-2.5.1/msticpy/common/provider_settings.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/proxy_settings.py` & `msticpy-2.5.1/msticpy/common/proxy_settings.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/settings.py` & `msticpy-2.5.1/msticpy/common/settings.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/timespan.py` & `msticpy-2.5.1/msticpy/common/timespan.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/utility/__init__.py` & `msticpy-2.5.1/msticpy/common/utility/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/utility/format.py` & `msticpy-2.5.1/msticpy/common/utility/format.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/utility/ipython.py` & `msticpy-2.5.1/msticpy/common/utility/ipython.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/utility/package.py` & `msticpy-2.5.1/msticpy/common/utility/package.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/utility/types.py` & `msticpy-2.5.1/msticpy/common/utility/types.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/common/wsconfig.py` & `msticpy-2.5.1/msticpy/common/wsconfig.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/__init__.py` & `msticpy-2.5.1/msticpy/config/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/ce_azure.py` & `msticpy-2.5.1/msticpy/config/ce_azure.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/ce_azure_sentinel.py` & `msticpy-2.5.1/msticpy/config/ce_azure_sentinel.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/ce_common.py` & `msticpy-2.5.1/msticpy/config/ce_common.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/ce_data_providers.py` & `msticpy-2.5.1/msticpy/config/ce_data_providers.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/ce_keyvault.py` & `msticpy-2.5.1/msticpy/config/ce_keyvault.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/ce_msticpy.py` & `msticpy-2.5.1/msticpy/config/ce_msticpy.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/ce_other_providers.py` & `msticpy-2.5.1/msticpy/config/ce_other_providers.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/ce_provider_base.py` & `msticpy-2.5.1/msticpy/config/ce_provider_base.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/ce_simple_settings.py` & `msticpy-2.5.1/msticpy/config/ce_simple_settings.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/ce_ti_providers.py` & `msticpy-2.5.1/msticpy/config/ce_ti_providers.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/ce_user_defaults.py` & `msticpy-2.5.1/msticpy/config/ce_user_defaults.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/comp_edit.py` & `msticpy-2.5.1/msticpy/config/comp_edit.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/compound_ctrls.py` & `msticpy-2.5.1/msticpy/config/compound_ctrls.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/file_browser.py` & `msticpy-2.5.1/msticpy/config/file_browser.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/mp_config_control.py` & `msticpy-2.5.1/msticpy/config/mp_config_control.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/mp_config_edit.py` & `msticpy-2.5.1/msticpy/config/mp_config_edit.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/config/mp_config_file.py` & `msticpy-2.5.1/msticpy/config/mp_config_file.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/__init__.py` & `msticpy-2.5.1/msticpy/context/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/azure/azure_data.py` & `msticpy-2.5.1/msticpy/context/azure/azure_data.py`
...
### Comparing `msticpy-2.5.0/msticpy/context/azure/sentinel_analytics.py` & `msticpy-2.5.1/msticpy/context/azure/sentinel_analytics.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/azure/sentinel_bookmarks.py` & `msticpy-2.5.1/msticpy/context/azure/sentinel_bookmarks.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/azure/sentinel_core.py` & `msticpy-2.5.1/msticpy/context/azure/sentinel_core.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/azure/sentinel_dynamic_summary.py` & `msticpy-2.5.1/msticpy/context/azure/sentinel_dynamic_summary.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/azure/sentinel_dynamic_summary_types.py` & `msticpy-2.5.1/msticpy/context/azure/sentinel_dynamic_summary_types.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/azure/sentinel_incidents.py` & `msticpy-2.5.1/msticpy/context/azure/sentinel_incidents.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/azure/sentinel_search.py` & `msticpy-2.5.1/msticpy/context/azure/sentinel_search.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/azure/sentinel_ti.py` & `msticpy-2.5.1/msticpy/context/azure/sentinel_ti.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/azure/sentinel_utils.py` & `msticpy-2.5.1/msticpy/context/azure/sentinel_utils.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/azure/sentinel_watchlists.py` & `msticpy-2.5.1/msticpy/context/azure/sentinel_watchlists.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/azure/sentinel_workspaces.py` & `msticpy-2.5.1/msticpy/context/azure/sentinel_workspaces.py`
...
### Comparing `msticpy-2.5.0/msticpy/context/contextlookup.py` & `msticpy-2.5.1/msticpy/context/contextlookup.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/contextproviders/context_provider_base.py` & `msticpy-2.5.1/msticpy/context/contextproviders/context_provider_base.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/contextproviders/http_context_provider.py` & `msticpy-2.5.1/msticpy/context/contextproviders/http_context_provider.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/contextproviders/servicenow.py` & `msticpy-2.5.1/msticpy/context/contextproviders/servicenow.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/domain_utils.py` & `msticpy-2.5.1/msticpy/context/domain_utils.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/geoip.py` & `msticpy-2.5.1/msticpy/context/geoip.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/http_provider.py` & `msticpy-2.5.1/msticpy/context/http_provider.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/ip_utils.py` & `msticpy-2.5.1/msticpy/context/ip_utils.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/lookup.py` & `msticpy-2.5.1/msticpy/context/lookup.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/lookup_result.py` & `msticpy-2.5.1/msticpy/context/lookup_result.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/preprocess_observable.py` & `msticpy-2.5.1/msticpy/context/preprocess_observable.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/provider_base.py` & `msticpy-2.5.1/msticpy/context/provider_base.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tilookup.py` & `msticpy-2.5.1/msticpy/context/tilookup.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/__init__.py` & `msticpy-2.5.1/msticpy/context/tiproviders/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/alienvault_otx.py` & `msticpy-2.5.1/msticpy/context/tiproviders/alienvault_otx.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/azure_sent_byoti.py` & `msticpy-2.5.1/msticpy/context/tiproviders/azure_sent_byoti.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/greynoise.py` & `msticpy-2.5.1/msticpy/context/tiproviders/greynoise.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/ibm_xforce.py` & `msticpy-2.5.1/msticpy/context/tiproviders/ibm_xforce.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/intsights.py` & `msticpy-2.5.1/msticpy/context/tiproviders/intsights.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/kql_base.py` & `msticpy-2.5.1/msticpy/context/tiproviders/kql_base.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/mblookup.py` & `msticpy-2.5.1/msticpy/context/tiproviders/mblookup.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/open_page_rank.py` & `msticpy-2.5.1/msticpy/context/tiproviders/open_page_rank.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/pulsedive.py` & `msticpy-2.5.1/msticpy/context/tiproviders/pulsedive.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/result_severity.py` & `msticpy-2.5.1/msticpy/context/tiproviders/result_severity.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/riskiq.py` & `msticpy-2.5.1/msticpy/context/tiproviders/riskiq.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/ti_http_provider.py` & `msticpy-2.5.1/msticpy/context/tiproviders/ti_http_provider.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/ti_provider_base.py` & `msticpy-2.5.1/msticpy/context/tiproviders/ti_provider_base.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/tor_exit_nodes.py` & `msticpy-2.5.1/msticpy/context/tiproviders/tor_exit_nodes.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/tiproviders/virustotal.py` & `msticpy-2.5.1/msticpy/context/tiproviders/virustotal.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/vtlookupv3/__init__.py` & `msticpy-2.5.1/msticpy/context/vtlookupv3/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/vtlookupv3/vtfile_behavior.py` & `msticpy-2.5.1/msticpy/context/vtlookupv3/vtfile_behavior.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/vtlookupv3/vtlookup.py` & `msticpy-2.5.1/msticpy/context/vtlookupv3/vtlookup.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/context/vtlookupv3/vtlookupv3.py` & `msticpy-2.5.1/msticpy/context/vtlookupv3/vtlookupv3.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/__init__.py` & `msticpy-2.5.1/msticpy/data/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/azure/__init__.py` & `msticpy-2.5.1/msticpy/data/azure/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/azure/azure_blob_storage.py` & `msticpy-2.5.1/msticpy/data/azure/azure_blob_storage.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/azure/azure_data.py` & `msticpy-2.5.1/msticpy/data/azure/azure_data.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/azure_blob_storage.py` & `msticpy-2.5.1/msticpy/data/azure_blob_storage.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/azure_data.py` & `msticpy-2.5.1/msticpy/data/azure_data.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/azure_sentinel.py` & `msticpy-2.5.1/msticpy/data/azure_sentinel.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/core/data_providers.py` & `msticpy-2.5.1/msticpy/data/core/data_providers.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/core/data_query_reader.py` & `msticpy-2.5.1/msticpy/data/core/data_query_reader.py`
...
### Comparing `msticpy-2.5.0/msticpy/data/core/param_extractor.py` & `msticpy-2.5.1/msticpy/data/core/param_extractor.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/core/query_container.py` & `msticpy-2.5.1/msticpy/data/core/query_container.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/core/query_defns.py` & `msticpy-2.5.1/msticpy/data/core/query_defns.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/core/query_provider_connections_mixin.py` & `msticpy-2.5.1/msticpy/data/core/query_provider_connections_mixin.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/core/query_provider_utils_mixin.py` & `msticpy-2.5.1/msticpy/data/core/query_provider_utils_mixin.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/core/query_source.py` & `msticpy-2.5.1/msticpy/data/core/query_source.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/core/query_store.py` & `msticpy-2.5.1/msticpy/data/core/query_store.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/core/query_template.py` & `msticpy-2.5.1/msticpy/data/core/query_template.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/data_obfus.py` & `msticpy-2.5.1/msticpy/data/data_obfus.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/data_providers.py` & `msticpy-2.5.1/msticpy/data/data_providers.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/__init__.py` & `msticpy-2.5.1/msticpy/data/drivers/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/azure_kusto_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/azure_kusto_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/azure_monitor_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/azure_monitor_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/cybereason_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/cybereason_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/driver_base.py` & `msticpy-2.5.1/msticpy/data/drivers/driver_base.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/elastic_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/elastic_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/kql_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/kql_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/kusto_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/kusto_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/local_data_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/local_data_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/local_osquery_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/local_osquery_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/mdatp_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/mdatp_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/mordor_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/mordor_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/odata_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/odata_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/resource_graph_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/resource_graph_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/security_graph_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/security_graph_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/sentinel_query_reader.py` & `msticpy-2.5.1/msticpy/data/drivers/sentinel_query_reader.py`
...
### Comparing `msticpy-2.5.0/msticpy/data/drivers/splunk_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/splunk_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/drivers/sumologic_driver.py` & `msticpy-2.5.1/msticpy/data/drivers/sumologic_driver.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/cybereason/cybereason_connections.yaml` & `msticpy-2.5.1/msticpy/data/queries/cybereason/cybereason_connections.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/cybereason/cybereason_hosts.yaml` & `msticpy-2.5.1/msticpy/data/queries/cybereason/cybereason_hosts.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/cybereason/cybereason_processes.yaml` & `msticpy-2.5.1/msticpy/data/queries/cybereason/cybereason_processes.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/localdata/local_data.yaml` & `msticpy-2.5.1/msticpy/data/queries/localdata/local_data.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/m365d/kql_mdatp_alerts.yaml` & `msticpy-2.5.1/msticpy/data/queries/m365d/kql_mdatp_alerts.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/m365d/kql_mdatp_file.yaml` & `msticpy-2.5.1/msticpy/data/queries/m365d/kql_mdatp_file.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/m365d/kql_mdatp_hunting.yaml` & `msticpy-2.5.1/msticpy/data/queries/m365d/kql_mdatp_hunting.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/m365d/kql_mdatp_network.yaml` & `msticpy-2.5.1/msticpy/data/queries/m365d/kql_mdatp_network.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/m365d/kql_mdatp_process.yaml` & `msticpy-2.5.1/msticpy/data/queries/m365d/kql_mdatp_process.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/m365d/kql_mdatp_user.yaml` & `msticpy-2.5.1/msticpy/data/queries/m365d/kql_mdatp_user.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mde/kql_mdatp_alerts.yaml` & `msticpy-2.5.1/msticpy/data/queries/mde/kql_mdatp_alerts.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mde/kql_mdatp_file.yaml` & `msticpy-2.5.1/msticpy/data/queries/mde/kql_mdatp_file.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mde/kql_mdatp_hunting.yaml` & `msticpy-2.5.1/msticpy/data/queries/mde/kql_mdatp_hunting.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mde/kql_mdatp_network.yaml` & `msticpy-2.5.1/msticpy/data/queries/mde/kql_mdatp_network.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mde/kql_mdatp_process.yaml` & `msticpy-2.5.1/msticpy/data/queries/mde/kql_mdatp_process.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mde/kql_mdatp_user.yaml` & `msticpy-2.5.1/msticpy/data/queries/mde/kql_mdatp_user.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/msgraph/graph_alerts.yaml` & `msticpy-2.5.1/msticpy/data/queries/msgraph/graph_alerts.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_alert.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_alert.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_az_dns.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_az_dns.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_az_network.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_az_network.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_azure.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_azure.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_azuresentinel.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_azuresentinel.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_heartbeat_info.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_heartbeat_info.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_lxauditd.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_lxauditd.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_lxsyslog_activity.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_lxsyslog_activity.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_lxsyslog_apps.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_lxsyslog_apps.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_lxsyslog_logon.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_lxsyslog_logon.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_lxsyslog_sysmon.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_lxsyslog_sysmon.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_net.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_net.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_o365.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_o365.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_threatintel.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_threatintel.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_timeseries.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_timeseries.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_winevent.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_winevent.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_winevent_logon.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_winevent_logon.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/mssentinel/kql_sent_winevent_proc.yaml` & `msticpy-2.5.1/msticpy/data/queries/mssentinel/kql_sent_winevent_proc.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/resourcegraph/resource_graph_queries.yaml` & `msticpy-2.5.1/msticpy/data/queries/resourcegraph/resource_graph_queries.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/resourcegraph/sentinel_resources.yaml` & `msticpy-2.5.1/msticpy/data/queries/resourcegraph/sentinel_resources.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/splunk/splunk_alert_queries.yaml` & `msticpy-2.5.1/msticpy/data/queries/splunk/splunk_alert_queries.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/splunk/splunk_authentication_queries.yaml` & `msticpy-2.5.1/msticpy/data/queries/splunk/splunk_authentication_queries.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/splunk/splunk_queries.yaml` & `msticpy-2.5.1/msticpy/data/queries/splunk/splunk_queries.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/queries/sumologic/sumologic_queries.yaml` & `msticpy-2.5.1/msticpy/data/queries/sumologic/sumologic_queries.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/query_container.py` & `msticpy-2.5.1/msticpy/data/query_container.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/query_defns.py` & `msticpy-2.5.1/msticpy/data/query_defns.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/sql_to_kql.py` & `msticpy-2.5.1/msticpy/data/sql_to_kql.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/storage/azure_blob_storage.py` & `msticpy-2.5.1/msticpy/data/storage/azure_blob_storage.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/uploaders/__init__.py` & `msticpy-2.5.1/msticpy/data/uploaders/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/uploaders/loganalytics_uploader.py` & `msticpy-2.5.1/msticpy/data/uploaders/loganalytics_uploader.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/uploaders/splunk_uploader.py` & `msticpy-2.5.1/msticpy/data/uploaders/splunk_uploader.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/data/uploaders/uploader_base.py` & `msticpy-2.5.1/msticpy/data/uploaders/uploader_base.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/__init__.py` & `msticpy-2.5.1/msticpy/datamodel/entities/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/account.py` & `msticpy-2.5.1/msticpy/datamodel/entities/account.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/alert.py` & `msticpy-2.5.1/msticpy/datamodel/entities/alert.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/azure_resource.py` & `msticpy-2.5.1/msticpy/datamodel/entities/azure_resource.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/cloud_application.py` & `msticpy-2.5.1/msticpy/datamodel/entities/cloud_application.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/cloud_logon_session.py` & `msticpy-2.5.1/msticpy/datamodel/entities/cloud_logon_session.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/dns.py` & `msticpy-2.5.1/msticpy/datamodel/entities/dns.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/entity.py` & `msticpy-2.5.1/msticpy/datamodel/entities/entity.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/entity_enums.py` & `msticpy-2.5.1/msticpy/datamodel/entities/entity_enums.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/entity_graph.py` & `msticpy-2.5.1/msticpy/datamodel/entities/entity_graph.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/file.py` & `msticpy-2.5.1/msticpy/datamodel/entities/file.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/file_hash.py` & `msticpy-2.5.1/msticpy/datamodel/entities/file_hash.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/geo_location.py` & `msticpy-2.5.1/msticpy/datamodel/entities/geo_location.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/graph_property.py` & `msticpy-2.5.1/msticpy/datamodel/entities/graph_property.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/host.py` & `msticpy-2.5.1/msticpy/datamodel/entities/host.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/host_logon_session.py` & `msticpy-2.5.1/msticpy/datamodel/entities/host_logon_session.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/iot_device.py` & `msticpy-2.5.1/msticpy/datamodel/entities/iot_device.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/ip_address.py` & `msticpy-2.5.1/msticpy/datamodel/entities/ip_address.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/mail_cluster.py` & `msticpy-2.5.1/msticpy/datamodel/entities/mail_cluster.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/mail_message.py` & `msticpy-2.5.1/msticpy/datamodel/entities/mail_message.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/mailbox.py` & `msticpy-2.5.1/msticpy/datamodel/entities/mailbox.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/malware.py` & `msticpy-2.5.1/msticpy/datamodel/entities/malware.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/network_connection.py` & `msticpy-2.5.1/msticpy/datamodel/entities/network_connection.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/process.py` & `msticpy-2.5.1/msticpy/datamodel/entities/process.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/registry_key.py` & `msticpy-2.5.1/msticpy/datamodel/entities/registry_key.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/registry_value.py` & `msticpy-2.5.1/msticpy/datamodel/entities/registry_value.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/security_group.py` & `msticpy-2.5.1/msticpy/datamodel/entities/security_group.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/submission_mail.py` & `msticpy-2.5.1/msticpy/datamodel/entities/submission_mail.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/threat_intelligence.py` & `msticpy-2.5.1/msticpy/datamodel/entities/threat_intelligence.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/unknown_entity.py` & `msticpy-2.5.1/msticpy/datamodel/entities/unknown_entity.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/entities/url.py` & `msticpy-2.5.1/msticpy/datamodel/entities/url.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/pivot.py` & `msticpy-2.5.1/msticpy/datamodel/pivot.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/soc/incident.py` & `msticpy-2.5.1/msticpy/datamodel/soc/incident.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/datamodel/soc/sentinel_alert.py` & `msticpy-2.5.1/msticpy/datamodel/soc/sentinel_alert.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/__init__.py` & `msticpy-2.5.1/msticpy/init/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/azure_ml_tools.py` & `msticpy-2.5.1/msticpy/init/azure_ml_tools.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/azure_synapse_tools.py` & `msticpy-2.5.1/msticpy/init/azure_synapse_tools.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/logging.py` & `msticpy-2.5.1/msticpy/init/logging.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/mp_pandas_accessors.py` & `msticpy-2.5.1/msticpy/init/mp_pandas_accessors.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/mp_plugins.py` & `msticpy-2.5.1/msticpy/init/mp_plugins.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/nbinit.py` & `msticpy-2.5.1/msticpy/init/nbinit.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/nbmagics.py` & `msticpy-2.5.1/msticpy/init/nbmagics.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/pivot.py` & `msticpy-2.5.1/msticpy/init/pivot.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/pivot_core/pivot_browser.py` & `msticpy-2.5.1/msticpy/init/pivot_core/pivot_browser.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/pivot_core/pivot_container.py` & `msticpy-2.5.1/msticpy/init/pivot_core/pivot_container.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/pivot_core/pivot_magic_core.py` & `msticpy-2.5.1/msticpy/init/pivot_core/pivot_magic_core.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/pivot_core/pivot_pd_accessor.py` & `msticpy-2.5.1/msticpy/init/pivot_core/pivot_pd_accessor.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/pivot_core/pivot_pipeline.py` & `msticpy-2.5.1/msticpy/init/pivot_core/pivot_pipeline.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/pivot_core/pivot_register.py` & `msticpy-2.5.1/msticpy/init/pivot_core/pivot_register.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/pivot_core/pivot_register_reader.py` & `msticpy-2.5.1/msticpy/init/pivot_core/pivot_register_reader.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/pivot_init/pivot_data_queries.py` & `msticpy-2.5.1/msticpy/init/pivot_init/pivot_data_queries.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/pivot_init/pivot_ti_provider.py` & `msticpy-2.5.1/msticpy/init/pivot_init/pivot_ti_provider.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/pivot_init/vt_pivot.py` & `msticpy-2.5.1/msticpy/init/pivot_init/vt_pivot.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/init/user_config.py` & `msticpy-2.5.1/msticpy/init/user_config.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/__init__.py` & `msticpy-2.5.1/msticpy/nbtools/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/data_viewer.py` & `msticpy-2.5.1/msticpy/nbtools/data_viewer.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/entityschema.py` & `msticpy-2.5.1/msticpy/nbtools/entityschema.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/foliummap.py` & `msticpy-2.5.1/msticpy/nbtools/foliummap.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/morph_charts.py` & `msticpy-2.5.1/msticpy/nbtools/morph_charts.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/nbdisplay.py` & `msticpy-2.5.1/msticpy/nbtools/nbdisplay.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/nbwidgets.py` & `msticpy-2.5.1/msticpy/nbtools/nbwidgets.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/observationlist.py` & `msticpy-2.5.1/msticpy/nbtools/observationlist.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/process_tree.py` & `msticpy-2.5.1/msticpy/nbtools/process_tree.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/security_alert.py` & `msticpy-2.5.1/msticpy/nbtools/security_alert.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/security_alert_graph.py` & `msticpy-2.5.1/msticpy/nbtools/security_alert_graph.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/security_base.py` & `msticpy-2.5.1/msticpy/nbtools/security_base.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/security_event.py` & `msticpy-2.5.1/msticpy/nbtools/security_event.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/ti_browser.py` & `msticpy-2.5.1/msticpy/nbtools/ti_browser.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/timeline.py` & `msticpy-2.5.1/msticpy/nbtools/timeline.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/timeline_duration.py` & `msticpy-2.5.1/msticpy/nbtools/timeline_duration.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/timeline_pd_accessor.py` & `msticpy-2.5.1/msticpy/nbtools/timeline_pd_accessor.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/timeseries.py` & `msticpy-2.5.1/msticpy/nbtools/timeseries.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/utility.py` & `msticpy-2.5.1/msticpy/nbtools/utility.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbtools/wsconfig.py` & `msticpy-2.5.1/msticpy/nbtools/wsconfig.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbwidgets/__init__.py` & `msticpy-2.5.1/msticpy/nbwidgets/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbwidgets/core.py` & `msticpy-2.5.1/msticpy/nbwidgets/core.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbwidgets/get_environment_key.py` & `msticpy-2.5.1/msticpy/nbwidgets/get_environment_key.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbwidgets/get_text.py` & `msticpy-2.5.1/msticpy/nbwidgets/get_text.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbwidgets/lookback.py` & `msticpy-2.5.1/msticpy/nbwidgets/lookback.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbwidgets/option_buttons.py` & `msticpy-2.5.1/msticpy/nbwidgets/option_buttons.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbwidgets/progress.py` & `msticpy-2.5.1/msticpy/nbwidgets/progress.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbwidgets/query_time.py` & `msticpy-2.5.1/msticpy/nbwidgets/query_time.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbwidgets/select_alert.py` & `msticpy-2.5.1/msticpy/nbwidgets/select_alert.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbwidgets/select_item.py` & `msticpy-2.5.1/msticpy/nbwidgets/select_item.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/nbwidgets/select_subset.py` & `msticpy-2.5.1/msticpy/nbwidgets/select_subset.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/resources/WinSecurityEvent.json` & `msticpy-2.5.1/msticpy/resources/WinSecurityEvent.json`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/resources/mp_pivot_reg.yaml` & `msticpy-2.5.1/msticpy/resources/mp_pivot_reg.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/resources/mpconfig_defaults.yaml` & `msticpy-2.5.1/msticpy/resources/mpconfig_defaults.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/resources/obfuscation_cols.yaml` & `msticpy-2.5.1/msticpy/resources/obfuscation_cols.yaml`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/__init__.py` & `msticpy-2.5.1/msticpy/sectools/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/auditdextract.py` & `msticpy-2.5.1/msticpy/sectools/auditdextract.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/base64unpack.py` & `msticpy-2.5.1/msticpy/sectools/base64unpack.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/cmd_line.py` & `msticpy-2.5.1/msticpy/sectools/cmd_line.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/domain_utils.py` & `msticpy-2.5.1/msticpy/sectools/domain_utils.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/eventcluster.py` & `msticpy-2.5.1/msticpy/sectools/eventcluster.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/geoip.py` & `msticpy-2.5.1/msticpy/sectools/geoip.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/iocextract.py` & `msticpy-2.5.1/msticpy/sectools/iocextract.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/ip_utils.py` & `msticpy-2.5.1/msticpy/sectools/ip_utils.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/proc_tree_build_mde.py` & `msticpy-2.5.1/msticpy/sectools/proc_tree_build_mde.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/proc_tree_build_winlx.py` & `msticpy-2.5.1/msticpy/sectools/proc_tree_build_winlx.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/proc_tree_builder.py` & `msticpy-2.5.1/msticpy/sectools/proc_tree_builder.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/proc_tree_schema.py` & `msticpy-2.5.1/msticpy/sectools/proc_tree_schema.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/proc_tree_utils.py` & `msticpy-2.5.1/msticpy/sectools/proc_tree_utils.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/sectools_magics.py` & `msticpy-2.5.1/msticpy/sectools/sectools_magics.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/syslog_utils.py` & `msticpy-2.5.1/msticpy/sectools/syslog_utils.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/tilookup.py` & `msticpy-2.5.1/msticpy/sectools/tilookup.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/tiproviders/ti_provider_base.py` & `msticpy-2.5.1/msticpy/sectools/tiproviders/ti_provider_base.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/vtlookup.py` & `msticpy-2.5.1/msticpy/sectools/vtlookup.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/vtlookupv3/__init__.py` & `msticpy-2.5.1/msticpy/sectools/vtlookupv3/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/vtlookupv3/vtfile_behavior.py` & `msticpy-2.5.1/msticpy/sectools/vtlookupv3/vtfile_behavior.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/vtlookupv3/vtlookupv3.py` & `msticpy-2.5.1/msticpy/sectools/vtlookupv3/vtlookupv3.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/sectools/vtlookupv3/vtobject_browser.py` & `msticpy-2.5.1/msticpy/sectools/vtlookupv3/vtobject_browser.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/transform/auditdextract.py` & `msticpy-2.5.1/msticpy/transform/auditdextract.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/transform/base64unpack.py` & `msticpy-2.5.1/msticpy/transform/base64unpack.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/transform/cmd_line.py` & `msticpy-2.5.1/msticpy/transform/cmd_line.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/transform/iocextract.py` & `msticpy-2.5.1/msticpy/transform/iocextract.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/transform/network.py` & `msticpy-2.5.1/msticpy/transform/network.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/transform/proc_tree_build_mde.py` & `msticpy-2.5.1/msticpy/transform/proc_tree_build_mde.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/transform/proc_tree_build_winlx.py` & `msticpy-2.5.1/msticpy/transform/proc_tree_build_winlx.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/transform/proc_tree_builder.py` & `msticpy-2.5.1/msticpy/transform/proc_tree_builder.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/transform/proc_tree_schema.py` & `msticpy-2.5.1/msticpy/transform/proc_tree_schema.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/transform/process_tree_utils.py` & `msticpy-2.5.1/msticpy/transform/process_tree_utils.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/__init__.py` & `msticpy-2.5.1/msticpy/vis/__init__.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/code_view.py` & `msticpy-2.5.1/msticpy/vis/code_view.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/data_viewer.py` & `msticpy-2.5.1/msticpy/vis/data_viewer.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/data_viewer_panel.py` & `msticpy-2.5.1/msticpy/vis/data_viewer_panel.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/entity_graph_tools.py` & `msticpy-2.5.1/msticpy/vis/entity_graph_tools.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/figure_dimension.py` & `msticpy-2.5.1/msticpy/vis/figure_dimension.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/foliummap.py` & `msticpy-2.5.1/msticpy/vis/foliummap.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/matrix_plot.py` & `msticpy-2.5.1/msticpy/vis/matrix_plot.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/mordor_browser.py` & `msticpy-2.5.1/msticpy/vis/mordor_browser.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/morph_charts.py` & `msticpy-2.5.1/msticpy/vis/morph_charts.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/mp_pandas_plot.py` & `msticpy-2.5.1/msticpy/vis/mp_pandas_plot.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/nbdisplay.py` & `msticpy-2.5.1/msticpy/vis/nbdisplay.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/network_plot.py` & `msticpy-2.5.1/msticpy/vis/network_plot.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/process_tree.py` & `msticpy-2.5.1/msticpy/vis/process_tree.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/query_browser.py` & `msticpy-2.5.1/msticpy/vis/query_browser.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/ti_browser.py` & `msticpy-2.5.1/msticpy/vis/ti_browser.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/timeline.py` & `msticpy-2.5.1/msticpy/vis/timeline.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/timeline_common.py` & `msticpy-2.5.1/msticpy/vis/timeline_common.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/timeline_duration.py` & `msticpy-2.5.1/msticpy/vis/timeline_duration.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/timeline_pd_accessor.py` & `msticpy-2.5.1/msticpy/vis/timeline_pd_accessor.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/timeline_values.py` & `msticpy-2.5.1/msticpy/vis/timeline_values.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/timeseries.py` & `msticpy-2.5.1/msticpy/vis/timeseries.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy/vis/vtobject_browser.py` & `msticpy-2.5.1/msticpy/vis/vtobject_browser.py`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy.egg-info/PKG-INFO` & `msticpy-2.5.1/msticpy.egg-info/PKG-INFO`
...
### Comparing `msticpy-2.5.0/msticpy.egg-info/SOURCES.txt` & `msticpy-2.5.1/msticpy.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/msticpy.egg-info/requires.txt` & `msticpy-2.5.1/msticpy.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/requirements-all.txt` & `msticpy-2.5.1/requirements-all.txt`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/requirements-dev.txt` & `msticpy-2.5.1/requirements-dev.txt`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/requirements.txt` & `msticpy-2.5.1/requirements.txt`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/setup.cfg` & `msticpy-2.5.1/setup.cfg`

 * *Files identical despite different names*

### Comparing `msticpy-2.5.0/setup.py` & `msticpy-2.5.1/setup.py`
